    ...
    <View style={[styles.container, tema]}>
      ...
      <View style={styles.section}>
        ...
        <View style={styles.buttonContainer}>
          ...
          <Button title="Botón Verde" color="#62d27cff" onPress={() => {}} />
          <Button title="Botón Amarillo" color="#f3d066ff" onPress={() => {}} />
          <Button title="Botón Rojo" color="#f05c6bff" onPress={() => {}} />
          <Button title="Botón Morado" color="#9a6feaff" onPress={() => {}} />
