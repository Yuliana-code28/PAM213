import React, {useEffect, useState} from 'react'; //useEffect se usa para hacer un temporizador
import { View, Text, StyleSheet, ImageBackground, Image, TouchableOpacity, StatusBar } from 'react-native';

const flores = require('../assets/Recursos/gatito.jpg');//inicio 
const hojas = require('../assets/Recursos/Jinx.webp');
const LOGO_IMAGE = require('../assets/Recursos/neon.jpg'); //icono
export default function ImagenScreen () {
    const[isLoading, setIsLoading] = useState (true);

    useEffect(() => {
      const timer = setTimeout(() => {
        setIsLoading(false); //esta en falso para que oculte el splash screen
      }, 3000); //3 segundos
    ...
    return(
      ...
      >
       ...
       <View style={styles.mainOverlay}>
        ...
        <TouchableOpacity
        style={styles.button}
        onPress={() => alert('Botoón presionado')}
        >
